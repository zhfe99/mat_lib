...
%   modify  -  Feng Zhou (zhfe99@gmail.com), 06-19-2014
...
elseif strcmp(alg, 'mosek')
    ...
    %% you need to manually rename the "quadprog.m" to in the MOSEK libaray to "quadprog2.m"
    option = optimset('Display', 'off', 'LargeScale', 'on');
    x = quadprog2(H, f, A, buc, AEq, bEq, blx, bux, x0, option);

function clfy = clfyTrs(Xs, par)
% Train a multi-class classifier from the given data set.
%
% Input
%   Xs      -  sample matrix, 1 x k (cell), d x ni
%   par
%     type  -  method of combining bi-class to multi-class, {'ovm'} | 'ovo'
%     alg   -  method of basis classifier, {'svr'} | 'svc' | 'ksvr'
%     c     -  value of C
...
%     alg   -  method (copy from parameter)
%     type  -  method (copy from parameter)
%     svms  -  svm model, 1 x k (cell)
%     ti    -  time cost
%
% History
